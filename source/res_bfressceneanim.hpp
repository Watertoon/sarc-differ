...
namespace dd::res {
    ...
    struct ResBfresCameraAnimResultDefault {
        ...
        float aspect;
        float fovy;
        util::math::Vector3f position;
        util::math::Vector3f rotation;
        float twist;
    };
    static_assert(sizeof(ResBfresCameraAnimResultDefault) == 0x2c);

    enum BfresCameraAnimRotationMode   : u8 {
        BfresCameraAnimRotationMode_Aim,
        BfresCameraAnimRotationMode_EulerZXY,
    };

    enum BfresCameraAnimProjectionMode : u8 {
        BfresCameraAnimProjectionMode_Ortho,
        BfresCameraAnimProjectionMode_Perspective,
    };
    ...
    struct ResBfresCameraAnim {
        ...
        static constexpr u32 Magic = util::TCharCode32("FCAM");
    };
    ...
    struct ResBfresLightAnimResultDefault {
        ...
        util::math::Vector3f position;
        util::math::Vector3f rotation;
        util::math::Vector2f distance_attenuation;
        util::math::Vector2f angle_attenuation;
        util::math::Vector3f color0;
        util::math::Vector3f color1;
    };
    ...
    struct ResBfresFogAnim {
        ...
        static constexpr u32 Magic = util::TCharCode32("FFOG");
    };
    ...
    struct ResBfresSceneAnim {
        ...
        static constexpr u32 Magic = util::TCharCode32("FSCN");
    };
